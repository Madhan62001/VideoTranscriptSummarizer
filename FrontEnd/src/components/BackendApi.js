...
class BackendAPI extends React.Component {
				...
				(result) => {
					if (result.data.message === "Success") {
						this.setState({
							...
							tamilTranscript: result.data.tam_summary,
	...
	render() {
		...
		const { isLoaded, isLoading, message, englishTranscript, hindiTranscript, tamilTranscript, brailleText, originalTextLength, summarizedTextLength } = this.state;
			...
			return (
				<>
					...
					<Tabs>
						...
						<div label="Tamil">
							<div className="tab-content-1">
								Tamil Summarized Text Will be Shown Here...
							</div>
						</div>
						<div label="Braille">
							<div className="tab-content-1">
						...
						<Tabs>
							...
							<div label="Tamil">
								<div className="tab-content">
									<div>
										<center>
										<a href={TA} className="buttonDownload" download="Tamil_Transcript.txt" type="button">Download</a>
										</center>
									</div>
									{tamilTranscript}
								</div>
